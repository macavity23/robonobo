...
public class DbService extends AbstractService {
	...
	private static final String CREATE_PLAYLIST_SEEN_SIDS_TBL = "CREATE CACHED TABLE playlist_seen_sids (playlist_id BIGINT NOT NULL, stream_id VARCHAR(36) NOT NULL)";
	...
	private static final String CREATE_LIBRARY_SEEN_SIDS_TBL = "CREATE CACHED TABLE library_seen_sids (user_id BIGINT NOT NULL, stream_id VARCHAR(36) NOT NULL)";
