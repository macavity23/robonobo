...
public class HTTPServer {
    ...
    /**
     * Constructs an HTTPServer which can accept connections. Chooses a random port to listen on.
     * Note: the {@link #start()} method must be called to start accepting
     * connections.
     */
    public HTTPServer() {
    ...
    /**
     * Sets the port on which this server will accept connections. Port < 0 means random
     */
