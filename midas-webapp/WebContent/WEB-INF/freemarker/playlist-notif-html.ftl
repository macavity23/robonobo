...
<p style="color:#111111">Your friend ${updateUser.friendlyName} (<a href="mailto:${updateUser.email}" style="color:#5b0d01">${updateUser.email}</a>) has updated their playlist '${playlist.title}' (${playlist.streamIds?size} tracks).</p>
