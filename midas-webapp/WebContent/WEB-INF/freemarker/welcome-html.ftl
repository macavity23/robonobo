...
<h1>Welcome to robonobo</h1>

<p>Hello, ${toName}, and welcome to robonobo, the app that lets you share music with your friends while supporting artists.</p>

<p>To get started, visit <a href="${rbnbUrl}download">${rbnbUrl}download</a> and choose the type of computer you have. The download page will give you instructions for how to run robonobo on your computer.</p>
