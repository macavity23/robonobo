...
public abstract class AbstractTrackListTableModel extends AbstractTableModel implements TrackListTableModel {
	private static final int[] HIDDEN_COLS = new int[] { 4, 12 };
	static DateFormat df = new SimpleDateFormat("yyyy-MM-dd HH:mm");
	static String[] colNames = { " "/* StatusIcon */, "Title", "Artist", "Album", "Track", "Year", "Time", "Size", "Status",
